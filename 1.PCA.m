...
% PCA
% Storage in 'Res'£º
% 'PriAccC' is the number of files¡Á2 matrix, the first row represents the number of principal components retained, and the second row represents the percentage of variance explained by these principal components
% 'LastNum' is the number of data points for each fiber tract
% 'Res' is 96¡Áthe number of principal components¡Á42, which represents the result of the original data after PCA
